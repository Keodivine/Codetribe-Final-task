...
function productPrice(items) {
  ...
  priceSingle.textContent = `R125 * ${items}`;
  priceTotal.textContent = `R${125 * items}`;
  if (items >= 1) {
...
/*  image modal btn to change overlay image same as button image  */
...
/*  image to change when image button is clicked  */
